...
export default function Service_Details_Six() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={3} footerStyle={2} breadcrumbTitle="Business Finance">
                            ...
                            <div className="service-sidebar mr_40">
                                <div className="category-widget mb_40">
                                    <ul className="category-list clearfix">
                                        ...
                                        <li><Link href="/service-details-6" className='current'>Business Finance <i className="icon-42"></i></Link></li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="service-details-content">
                                <div className="sec-title mb_70">
                                    <span className="sub-title mb_10">Business Finance</span>
                                ...
                                <figure className="image-box mb_30"><img src="assets/images/service/img3.webp" alt=""/></figure>
                                <div className="text-box mb_110">
                                    <p className="mb_25">Our team has in-depth knowledge of various business sectors in New Zealand, ensuring you get advice that’s tailored to your industry’s specific financial needs and challenges.</p>
                                    <p>We have strong relationships with a diverse range of lenders, from major banks to specialised finance providers, giving you access to more options and potentially better terms.</p>
                                </div>
                                ...
                                <div className="tabs-box mb_50">
                                    ...
                                    <div className="tabs-content">
                                        ...
                                        <div className={activeIndex === 2 ? "tab active-tab" : "tab"}>
                                            <div className="inner-box">
                                                <figure className="image-box"><img src="assets/images/service/assetfinance.jpg" alt=""/></figure>
                                                <div className="content-box">
